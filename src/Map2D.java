...
public class Map2D<V>
{
  ...
  public long getHighX(){return high_x;}
  public long getHighY(){return high_y;}
  ...
  {
    TreeMap<V, Character> conv_map = new TreeMap<>();

    return getPrintOut(conv_map);
  }
